<template>
    <div class="download flex-y flex-center">
        <div class="add-estimate-modal">
            <div class="establishment-title">项目概算审定表</div>
            ...
            <div class="common-content flex-y">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-date-picker size="medium" placeholder="建设时间" v-model="applyTime" value-format="yyyy-MM-dd"
                            type="date" :style="{'width':'190px'}" :disabled="true">
                        </el-date-picker>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="3">
                        <div class="grid-content"><span>项目概算资金</span></div>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row class="interval">
                    <el-col :span="19">
                        <el-input placeholder="项目建设内容7" v-model="content7"></el-input>
                    </el-col>
                    <el-col :span="5">
                        <el-input placeholder="估算7" v-model="estimate7"></el-input>
                    </el-col>
                </el-row>
                <el-row class="interval">
                    <el-col :span="19">
                        <el-input placeholder="项目建设内容8" v-model="content8"></el-input>
                    </el-col>
                    <el-col :span="5">
                        <el-input placeholder="估算8" v-model="estimate8"></el-input>
                    </el-col>
                </el-row>
                <el-row class="interval">
                    <el-col :span="4">
                ...
                <el-row class="interval">
                    ...
                    <el-col :span="5">
                        <el-input placeholder="申请部门负责人" v-model="departmentLeader" :style="{'width':'130px'}">
                        </el-input>
                    </el-col>
                    <el-col :span="5">
                ...
                <el-row>
                    <el-col :span="4">
                        <div class="grid-content"><span>审计处初审意见</span></div>
                    </el-col>
                    <el-col :span="20">
                        <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 4}" placeholder="审计处初审意见"
                            v-model="auditAdvise">
                        </el-input>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" icon="el-icon-edit" @click="submit()"  :style="{'width':'150px','font-size':'18px','height':'50px'}" class="submit-button">提交
                            </el-button>
                        </div>
                    </el-col>
                </el-row>
...
<script>
    ...
    export default {
        name: 'add-estimate',
        props: ['id', 'addOrUpdate', "projectId","establishmentId"],
        data() {
            return {
                projectName: '',
                department: '',
        ...
        methods: {
            ...
            async submit() {
                ...
                var number = [this.estimate1, this.estimate2, this.estimate3, this.estimate4, this.estimate5, this
                    .estimate6, this.estimate7, this.estimate8
                ]
                var flag = 1;
                _.map(number, (v) => {
                    if (v != "" && v != null)
        ...
        console.log(this.establishmentId)
                     if (this.establishmentId != null && this.establishmentId != 0 && typeof this.establishmentId != 'undefined') {
                try {
            ...
            if (this.id != null && this.id != 0 && typeof this.id != 'undefined') {
                try {
                    ...
                    this.auditAdvise = res.data.auditAdvise
                } catch (e) {
                    console.log(e)
                    this.$message.error('出错啦');
                }
