                    ...
                    <el-row>
                        ...
                        <el-col :span="4">
                            <el-date-picker size="medium" placeholder="开始时间" v-model="constructionStartTime"
                                value-format="yyyy-MM" type="month" :style="{'width':'120px'}" :disabled="true">
                            </el-date-picker>
                        </el-col>
                        <el-col :span="4">
                        ...
                        <el-col :span="8">
                            <el-date-picker size="medium" placeholder="建设时间" v-model="applyTime"
                                value-format="yyyy-MM-dd" type="date" :style="{'width':'190px'}" :disabled="true">
                            </el-date-picker>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row class="interval">
                        ...
                        <el-col :span="15">
                            <div class="grid-content bg-purple-dark">
                                <el-button type="primary" icon="el-icon-tickets" @click="getTotal()"
                                    class="submit-button"
                                    :style="{'height':'30px','width':'80px','margin-top':'-10px','margin-left':'-170px'}">
                                    计算
                                </el-button>
                            </div>
                        </el-col>
                    ...
                    <el-row>
                        ...
                        <el-col :span="10">
                            <!-- <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 4}" placeholder="学校意见"
                                v-model="schoolAdvise" @change='handleChange' @focus='handleChange'>
                            </el-input> -->
                            <el-autocomplete  v-model="schoolAdvise"
...
<script>
    ...
    export default {
        ...
        props: ['id', 'addOrUpdate', "projectId", "estimateId", "name"],
        components: {
            Timeline
        },
        data() {
